<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Tambah Gedung</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="card card-success card-outline">
      ...
      <div class="card-body">
        ...
        <div class="col-md-12">
          <form method="POST" action="<?= site_url() ?>admin/gedung/simpan" enctype="multipart/form-data">

            <div class="form-group">
              <label for="nama_gedung" class="col-md-3 control-label">Nama Gedung</label>
              <input type="text" name="nama_gedung" class="form-control" placeholder="Nama Gedung" value="<?= set_value('nama_gedung') ?>">
            </div>
            ...
            <div class="form-group">
              ...
              <textarea name="keterangan" placeholder="Keterangan" rows="5" class="form-control"><?= set_value('keterangan') ?></textarea>
            </div>
