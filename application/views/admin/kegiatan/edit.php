  ...
  <div class="container-fluid">
    <div class="card card-success card-outline">
      ...
      <div class="card-body">
        ...
        <div class="col-md-12">
          <form method="POST" action="<?= site_url('admin/kegiatan/update/' . $kegiatan->id_kegiatan) ?>" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-12 col-md-5">
                <div class="form-group" style="border: 2px solid #ccc; padding: 10px;">
                  ...
                  <?php else : ?>
                    <img class="mt-3 img-fluid img-thumbnail" id='img-upload' style="width: 500px" src="<?= base_url('uploads/kegiatan/' . $kegiatan->foto_kegiatan) ?>">
                  <?php endif ?>
              ...
              <div class="col-md-7">
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kegiatan" class="form-control" placeholder="Nama Kegiatan" value="<?= isset($kegiatan) ? $kegiatan->nama_kegiatan : '' ?>">
                </div>

                <div class="form-group timepicker">
                  <label>Waktu Kegiatan</label>
                  <input type="text" class="form-control" name="jam" id="waktu_picker" value="<?= isset($kegiatan) ? $kegiatan->jam : '' ?>" placeholder="Klik Untuk Waktu">
                </div>

                <div class="form-group">
                  <label for="informasi" class="col-md-3 control-label">Tempat Kegiatan</label>
                  <input type="text" name="tempat" class="form-control" placeholder="Tempat Kegiatan" value="<?= isset($kegiatan) ? $kegiatan->tempat : '' ?>">
                </div>
              </div>
