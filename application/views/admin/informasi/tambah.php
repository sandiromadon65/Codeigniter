  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
        ...
        <div class="col-md-12">
          <form method="POST" action="<?= site_url()?>admin/informasi/simpan">

            <div class="form-group">
              <label for="judul" class="col-md-3 control-label">Judul Informasi</label>
              <input type="text" name="judul" class="form-control" placeholder="Judul Informasi" value="<?= set_value('judul')?>">
            </div>

            <div class="form-group">
              <label for="informasi" class="col-md-3 control-label">Informasi Lengkap</label>
              <textarea name="info" placeholder="Informasi Lengkap" rows="5" class="form-control"><?= set_value('info')?></textarea>
            </div>

            <div class="form-group timepicker">
              <label>Waktu Informasi</label>
              <input type="text" class="form-control waktu_picker" name="waktu" value="<?= set_value('waktu')?>" placeholder="Klik Untuk Waktu" >
            </div>
