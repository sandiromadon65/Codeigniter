<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Edit Data Galeri</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="card card-success card-outline">
      ...
      <div class="card-body">
        ...
        <div class="col-md-12">
          <form method="POST" action="<?= site_url('admin/galeri/update/' . $galeri->id_galeri) ?>" enctype="multipart/form-data">

            <div class="form-group">
              <label for="keterangan" class="col-md-3 control-label">Keterangan</label>
              <input type="text" name="keterangan" class="form-control" placeholder="Keterangan" value="<?= isset($galeri) ? $galeri->keterangan : '' ?>">
            </div>
            ...
            <div class="form-group" style="border: 2px solid #ccc; padding: 10px;">
              ...
              <?php if (empty($galeri->foto_galeri)) : ?>
                <img class="mt-3 img-fluid img-thumbnail" id='img-upload' style="width: 500px" src="<?= base_url('assets/images/no_image.png') ?>">
              <?php else : ?>
                <img class="mt-3 img-fluid img-thumbnail" id='img-upload' style="width: 500px" src="<?= base_url('uploads/galeri/' . $galeri->foto_galeri) ?>">
              <?php endif ?>
            </div>

            <div class="form-group timepicker">
              <label>Tanggal Posting</label>
              <input type="text" class="form-control" name="tgl_posting" id="waktu_picker" value="<?= isset($galeri) ? $galeri->tgl_posting : '' ?>" placeholder="Klik Untuk Waktu">
            </div>
