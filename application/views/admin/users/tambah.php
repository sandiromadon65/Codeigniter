    ...
    <div class="container-fluid">
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
                ...
                <div class="col-md-12">
                    <form method="POST" action="<?= site_url() ?>admin/users/simpan">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Nama Admin</label>
                            <input type="text" name="nama_admin" class="form-control" placeholder="Nama Admin" value="<?= set_value('nama_admin') ?>">
                        </div>
