...
*/
$autoload['libraries'] = array('database', 'session', 'login_checker', 'form_validation', 'struktur_organisasi_library');
...
*/
$autoload['helper'] = array('url', 'file', 'form', 'date', 'tanggal', 'my');
